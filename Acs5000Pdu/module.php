<?php
	...
	* Get the list of robots linked to this profile and modifies the Select list to allow the user to select them.
    ...
    public function RefreshInformation() {
		...
		$oid_mapping_table['Temperature'] = '.1.3.6.1.4.1.2925.8.5.9.1.7.' . $this->ReadPropertyInteger("PduIndex") . ".1.1";
		$conversionFactors['Temperature'] = 0.1;
		$oid_mapping_table['MaximumTemperature'] = '.1.3.6.1.4.1.2925.8.5.9.1.8.' . $this->ReadPropertyInteger("PduIndex") . ".1.1";
